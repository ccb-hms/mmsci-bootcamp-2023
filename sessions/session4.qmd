...
We can use the `select` function to display just these columns of interest. At this stage it will also be useful to rename the columns to something more convenient using the `rename` function.
